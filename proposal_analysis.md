...
+-----------------------------------------------------------------------+
| **Proponents**: III-DCSAD \| Group 6 -- XLR8                          |
+-----------------------------------------------------------------------+
...
| particularly pronounced students are regularly subjected to multiple  |
| overlapping deadlines, intensive programming projects, research       |
| requirements, extracurricular obligations, and performance-based      |
| assessments within the same academic period. The compounding nature   |
| of these demands leads to widespread concerns regarding cognitive     |
| overload, academic fatigue, and reduced learning productivity. As     |
| higher education institutions continue integrating digital learning   |
| environments and expanding their academic offerings, the need for     |
| intelligent, data-driven systems capable of monitoring and            |
| forecasting academic workload trends has become increasingly urgent.  |
| To ground this study in the institutional reality of its target       |
| population, a pre-survey was conducted among 33 undergraduate CCIS    |
| students of the University of Makati (AY 2025--2026, as of March 22,  |
| 2026), employing a tailored 40-item forced-choice 4-point Likert      |
| scale per year level (1,320 total responses across four year-level    |
| cohorts). The results yielded an overall weighted grand mean of       |
| 3.82/5 (Moderately High), with Motivation and Self-Improvement        |
| emerging as the highest-scoring dimension (M = 4.08, High) and Study  |
| Planning and Time Management as the lowest (M = 3.72) - a             |
| Motivation--Planning gap of Δ = 0.36 that quantifies the precise      |
| behavioral-structural discrepancy HeronPulse is designed to address.  |
|                                                                       |
...
| predictive machine learning model. The pre-survey findings provide    |
| institution-specific construct validity for each of these dimensions: |
| weekly goal-setting scored only M = 2.42 among 3rd year respondents   |
| and M = 3.33 among 4th year respondents, confirming that task density |
| and deadline management are the most underdeveloped behavioral        |
| competencies within the CCIS population; diagram creation - a proven  |
| cognitive load reduction strategy - scored M = 2.17 for 3rd year      |
| students, the lowest item observed across the entire instrument,      |
| validating Assessment Intensity as a consequential workload driver;   |
| and instructor consultation after low results scored M = 2.67 for 3rd |
| year and M = 3.17 for 4th year respondents, confirming that students  |
| internalize academic pressure rather than seek support - a documented |
| precursor to burnout. More critically, there is a notable absence of  |
| localized systems designed specifically for computing students in     |
| Philippine higher education institutions, whose academic structure is |
| predominantly project-heavy, deadline-driven, and research-intensive. |
| This gap presents a compelling opportunity to design a system that    |
| translates these measurable academic factors into a structured,       |
| quantifiable Academic Load Index (ALI) and forecasts future workload  |
| risk exposure using machine learning.                                 |
|                                                                       |
...
| levels across multiple dimensions simultaneously. The severity of     |
| this gap is most acutely evidenced by the pre-survey's year-level     |
| comparative analysis: 3rd year CCIS students - simultaneously         |
| managing major subject requirements, capstone initiation, and         |
| research proposal development - recorded the lowest scores across all |
| four dimensions (Study Planning: M = 3.48; Learning Methods: M =      |
| 3.40; Coping: M = 3.45; Motivation: M = 3.88; Year Mean: M = 3.55),   |
| and generated the highest negative response rate across all cohorts   |
| (Disagree + Strongly Disagree: 26.7%), establishing that the absence  |
| of a structured workload monitoring system creates its most severe    |
| impact precisely at the academic stage where demand density peaks.    |
|                                                                       |
...
| Misamis Occidental with 291 college student respondents, identified   |
| the third year as the highest-risk period for academic burnout onset  |
| among Filipino college students - a finding empirically mirrored in   |
| the CCIS UMak pre-survey data, wherein 3rd year students recorded the |
| lowest year mean across all categories (M = 3.55) and the steepest    |
| deficits in coping (M = 3.45) and learning methods (M = 3.40). Lim et |
| al. (2023) further characterized post-pandemic academic burnout among |
| Filipino college students as a condition in which individual effort   |
| is sustained but systemic support mechanisms remain underutilized - a |
| behavioral pattern directly reflected in the pre-survey's Coping      |
| dimension, where students reported strong post-exam reflection (high  |
| reflective scores) alongside critically low help-seeking behavior     |
| (instructor consultation: M = 2.67 for 3rd year). The combined        |
| positive response rate of 79.7% (1,052 out of 1,320 responses)        |
| confirms that this population is motivationally engaged and           |
| receptive - making the absence of a decision-support tool not a       |
| matter of student willingness but of structural provision. At the     |
| international level, studies by Wang and Luo (2024) and Ahmed et al.  |
| (2025) in Scientific Reports confirm that Gradient Boosting           |
| Regression achieves superior predictive accuracy for academic outcome |
| forecasting from structured institutional data - establishing the     |
| empirical basis for GBR as HeronPulse's primary algorithm.            |
|                                                                       |
...
| during peak assessment periods such as midterms and finals. These     |
| effects are measurably present within the CCIS population itself: the |
| pre-survey's respondent profile (3rd Year: n = 12, 36.4%; 4th Year: n |
| = 12, 36.4%; programs: BSCS n = 19, BSIT n = 13, Diploma n = 1)       |
| confirms that upper-year students - who bear the heaviest concurrent  |
| research, capstone, and academic assessment load - constitute 72.7%   |
| of the surveyed population, precisely the demographic for whom a      |
| proactive workload monitoring system carries the greatest             |
| institutional value. The Motivation--Planning discrepancy (Δ = 0.36:  |
| Motivation M = 4.08 vs. Planning M = 3.72) further demonstrates that  |
| the barrier to effective academic self-management is not motivational |
| insufficiency but the absence of structural scaffolding and advance   |
| warning. Addressing this systemic gap requires a structured Academic  |
| Load Index supported by Gradient Boosting Regression to enable        |
| proactive academic management, providing CCIS students and faculty    |
| advisers with actionable, data-validated workload insights before     |
| critical thresholds are breached rather than after harm has already   |
| occurred.                                                             |
|                                                                       |
...
| Ahmed et al. (2025, Scientific Reports) - and its native capacity to  |
| generate feature importance scores essential for ALI weight           |
| validation and refinement. The algorithm operates on the computed ALI |
| composite score as the prediction target and produces forecasts at    |
| 7-day, 14-day, and 30-day horizons. The 7-day horizon aligns with the |
| academic weekly planning cycle; the 14-day horizon covers the         |
| standard two-week assessment cycle in Philippine HEIs; and the 30-day |
| horizon enables strategic planning before major exam periods and      |
| capstone submission deadlines.                                        |
|                                                                       |
...
|                                                                       |
| > • Task Density - the number of active academic tasks (assignments,  |
| > activities, and projects) due within a rolling 7-day window,        |
| > weighted by estimated completion time per task                      |
| >                                                                     |
...
|                                                                       |
| > a\. Python 3.x - primary programming language for the ML pipeline,  |
| > data preprocessing, and backend processing                          |
| >                                                                     |
...
| > model development                                                   |
| >                                                                     |
| > e\. FastAPI - high-performance Python web framework for the system  |
...
|                                                                       |
| 6.  ALI Theory-Based vs. Data-Validated Weight Comparison Report - a  |
|     documented analysis comparing the initial Cognitive Load          |
...
| model for predicting student academic performance. Digital, 5(2), 16. |
| <https://doi.org/10.3390/digital5020016>                              |
|                                                                       |
...
| management system data and LSTM networks. Journal of Smart System and |
| Intelligent Learning, 1(1), 19--26.                                   |
...
| the Philippines. <https://www.privacy.gov.ph/data-privacy-act/>       |
|                                                                       |
...
| performance prediction of online learning. PLOS ONE, 20(1), e0299018. |
| <https://doi.org/10.1371/journal.pone.0299018>                        |
|                                                                       |
| Wang, S., & Luo, B. (2024). Academic achievement prediction in higher |
| education through interpretable modeling. PLOS One, 19(9), e0309838.  |
